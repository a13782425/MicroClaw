...
public sealed class McpServerConfigEntity
{
    ...
    [ConfigurationKeyName("transport_type")]
    ...
    [ConfigurationKeyName("args_json")]
    public string? ArgsJson { get; set; }

    /// <summary>stdio 传输：环境变量，JSON 对象序列化</summary>
    [ConfigurationKeyName("env_json")]
    ...
    [ConfigurationKeyName("headers_json")]
