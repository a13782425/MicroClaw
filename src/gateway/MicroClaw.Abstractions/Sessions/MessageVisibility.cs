...
public static class MessageVisibility
{
    ...
    public static bool IsVisibleToLlm(string? visibility) => visibility is null or All or LlmOnly;
    
    /// <summary>判断消息对前端是否可见。</summary>
    public static bool IsVisibleToFrontend(string? visibility) => visibility is null or All or FrontendOnly;
}