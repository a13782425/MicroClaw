...
public sealed record ToolResultItem(string CallId, string ToolName, string Result, bool Success, long DurationMs) : StreamItem
{
    public override string TypeName => "tool_result";
    public override object ToSerializablePayload() =>
        new
        {
            callId = CallId,
            toolName = ToolName,
...
public sealed record SubAgentStartItem(string AgentId, string AgentName, string Task, string RunId) : StreamItem
{
...
public sealed record SubAgentResultItem(string AgentId, string AgentName, string Result, long DurationMs, string RunId) : StreamItem
{
...
public sealed record SubAgentProgressItem(string AgentId, string Step, string RunId) : StreamItem
{
...
public sealed record WorkflowStartItem(string WorkflowId, string WorkflowName, string ExecutionId) : StreamItem
{
...
public sealed record WorkflowNodeStartItem(string ExecutionId, string NodeId, string NodeLabel, string NodeType) : StreamItem
{
...
public sealed record WorkflowNodeCompleteItem(string ExecutionId, string NodeId, string Result, long DurationMs) : StreamItem
{
...
public sealed record WorkflowEdgeItem(string ExecutionId, string SourceNodeId, string TargetNodeId, string? Condition) : StreamItem
{
...
public sealed record WorkflowCompleteItem(string ExecutionId, string FinalResult, long TotalDurationMs) : StreamItem
{
...
public sealed record WorkflowErrorItem(string ExecutionId, string NodeId, string Error) : StreamItem
{
...
public sealed record WorkflowWarningItem(string ExecutionId, string NodeId, string Warning) : StreamItem
{
...
public sealed record WorkflowModelSwitchItem(string ExecutionId, string NodeId, string ProviderId) : StreamItem
{
