...
public sealed class ConfigService
{
    ...
    public SystemConfigDto GetSystemConfig()
    {
        ...
        return new SystemConfigDto { Agent = new AgentConfigSection { SubAgentMaxDepth = agent.SubAgentMaxDepth }, Skills = new SkillsConfigSection { AdditionalFolders = skills.AdditionalFolders }, Emotion = EmotionConfigSection.FromOptions(emotion) };
    }
    ...
    public void UpdateAgentConfig(AgentConfigSection section)
    {
        ...
        var updated = new AgentsOptions { SubAgentMaxDepth = section.SubAgentMaxDepth, Items = current.Items };
    ...
    public void UpdateSkillsConfig(SkillsConfigSection section)
    {
        ...
        MicroClawConfig.Update(new SkillOptions { AllowCommandInjection = current.AllowCommandInjection, CatalogCharBudget = current.CatalogCharBudget, DefaultFolder = current.DefaultFolder, AdditionalFolders = [.. section.AdditionalFolders] });
    }
...
public sealed class EmotionDeltaConfigSection
{
    ...
    public static EmotionDeltaConfigSection FromOptions(EmotionDeltaOptions o) =>
        new()
        {
            Alertness = o.Alertness, Mood = o.Mood, Curiosity = o.Curiosity, Confidence = o.Confidence,
        };
    
    public EmotionDeltaOptions ToOptions() =>
        new()
        {
            Alertness = Alertness ?? 0, Mood = Mood ?? 0, Curiosity = Curiosity ?? 0, Confidence = Confidence ?? 0,
        };
}
