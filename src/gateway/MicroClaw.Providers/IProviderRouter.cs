...
public interface IProviderRouter
{
    ...
    /// <returns>选中的 <see cref="ChatMicroProvider"/>；若无可用 Provider 则返回 <c>null</c>。</returns>
    ChatMicroProvider? Route(IReadOnlyList<ChatMicroProvider> candidates, ProviderRoutingStrategy strategy);
    ...
    IReadOnlyList<ChatMicroProvider> GetFallbackChain(IReadOnlyList<ChatMicroProvider> candidates, ProviderRoutingStrategy strategy);
}
