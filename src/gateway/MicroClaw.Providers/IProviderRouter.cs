...
public interface IProviderRouter
{
    ...
    /// <returns>选中的 <see cref="ProviderEntity"/>；若无可用 Provider 则返回 <c>null</c>。</returns>
    ProviderEntity? Route(IReadOnlyList<ProviderEntity> candidates, ProviderRoutingStrategy strategy);
    ...
    IReadOnlyList<ProviderEntity> GetFallbackChain(IReadOnlyList<ProviderEntity> candidates, ProviderRoutingStrategy strategy);
}
