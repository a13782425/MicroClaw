...
public sealed class EmotionOptions : IMicroClawConfigTemplate
{
    ...
    [YamlMember(Alias = "delta_tool_success")]
    ...
    [YamlMember(Alias = "delta_task_completed")]
    ...
    [YamlMember(Alias = "delta_task_failed")]
    ...
    [YamlMember(Alias = "delta_pain_high")]
    ...
    [YamlMember(Alias = "delta_pain_critical")]
