...
public sealed class SkillOptions : IMicroClawConfigTemplate
{
    ...
    /// </summary>
    [YamlMember(Alias = "allow_command_injection", Description = "是否允许在技能指令中执行 shell 命令注入。")]
    ...
    /// </summary>
    [YamlMember(Alias = "catalog_char_budget", Description = "技能描述目录的最大字符预算。")]
    ...
    /// </summary>
    [YamlMember(Alias = "default_folder", Description = "默认技能文件夹路径。")]
    ...
    /// </summary>
    [YamlMember(Alias = "additional_folders", Description = "附加技能文件夹路径列表。")]
